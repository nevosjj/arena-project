...
# Grafiche
item replace block 9 -55 39 container.11 with minecraft:player_head[custom_data={headmvps:1b},minecraft:profile={properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzczZThiZDNjNDNjNDUxNGM3NjQ4MWNhMWRhZjU1MTQ5ZGZjOTNiZDFiY2ZhOGFiOTQzN2I5ZjdlYjMzOTJkOSJ9fX0="}]},minecraft:custom_name=[{"text":"Salva partita","color":"#2FFAD8","italic":false},{"text":" NON DISPONIBILE","color":"red","bold":true}]] 1
...
item replace block 9 -55 39 container.15 with minecraft:player_head[custom_data={headmvps:1b},minecraft:profile={properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNWQzMDhhZTI3YjU4YjY5NjQ1NDk3ZjlkYTg2NTk3ZWRhOTQ3ZWFjZDEwYzI5ZTNkNGJiZjNiYzc2Y2ViMWVhYiJ9fX0="}]},minecraft:custom_name={"text":"Migliori giocatori","color":"#2FFAD8","italic":false}] 1
