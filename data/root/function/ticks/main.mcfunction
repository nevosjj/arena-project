...
execute if score #match bool matches 1 as @a[tag=in_game,limit=1] if predicate {"type":"minecraft:entity_properties","entity":"this","predicate":{"minecraft:periodic_tick":20}} run function root:ticks/1second
