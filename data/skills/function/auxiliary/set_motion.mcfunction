...
$execute store result entity @s Motion[0] double 0.0$(motion) run \
scoreboard players operation @s motion.x2 -= @s motion.x1
$execute store result entity @s Motion[1] double 0.0$(motion) run \
scoreboard players operation @s motion.y2 -= @s motion.y1
$execute store result entity @s Motion[2] double 0.0$(motion) run \
